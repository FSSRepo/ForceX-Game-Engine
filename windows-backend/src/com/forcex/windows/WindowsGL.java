...
public class WindowsGL implements com.forcex.core.GL {
	...
	@Override
	public void glReadPixel(int x,int y,int width,int height,int format, Buffer buffer) {
		GL11.glReadPixels(x, y, width, height, format, GL11.GL_BYTE, (ByteBuffer)buffer);
	}
}
