...
import static com.forcex.math.Maths.abs;
import static com.forcex.math.Maths.cos;
import static com.forcex.math.Maths.sin;
import static com.forcex.math.Maths.sqr;
import static com.forcex.math.Maths.sqrt;
import static com.forcex.math.Maths.toDegrees;
import static com.forcex.math.Maths.toRadians;
...
public class Vector3f {
    ...
    public static Vector3f getUpFromDirection(Vector3f direction, boolean upZ) {
        float dot = upZ ? direction.z : direction.y;
    ...
    public Vector3f lerp(Vector3f end, float porcent) {
        return end.sub(this).multLocal(porcent).addLocal(this);
    }
    ...
    public Vector3f addLocal(float amount) {
        x += amount;
        y += amount;
        z += amount;
        return this;
