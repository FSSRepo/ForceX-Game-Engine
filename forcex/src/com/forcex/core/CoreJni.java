...
public class CoreJni {
    ...
    public static native void imageEncode(byte[] in, String path, int width, int height, int type);

    public static native byte[] imageDecodeFromPath(int[] info, String path);
    public static native byte[] imageDecodeFromMemory(int[] info, byte[] buffer);
