...
public class Cylinder extends Mesh {
    public Cylinder(int axisSamples, int radialSamples,
        ...
        float[] tex_coords = new float[numVertices * 2];
        ...
        for (int axisSample = 0; axisSample < axisSamples; axisSample++) {
            ...
            for (int circlePoint = 0; circlePoint < radialSamples + 1; circlePoint++) {
                ...
                tex_coords[currentIndex * 2] = (float) circlePoint / radialSamples;
                if (closed)
                    tex_coords[currentIndex * 2 + 1] = (bottomRadius + (height * 0.5f) + currentHeight) / (bottomRadius + height + topRadius);
                else
                    tex_coords[currentIndex * 2 + 1] = (height * 0.5f) + currentHeight;
                currentIndex++;
            }
        }
        if (closed) {
            ...
            for (int circlePoint = 0; circlePoint < radialSamples + 1; circlePoint++) {
                ...
                tex_coords[currentIndex * 2] = (float) circlePoint / radialSamples;
                tex_coords[currentIndex * 2 + 1] = bottomRadius / (bottomRadius + height + topRadius);
            ...
            for (int circlePoint = 0; circlePoint < radialSamples + 1; circlePoint++) {
                ...
                tex_coords[currentIndex * 2] = (float) circlePoint / radialSamples;
                tex_coords[currentIndex * 2 + 1] = (bottomRadius + height) / (bottomRadius + height + topRadius);
            ...
            tex_coords[currentIndex * 2] = 0.5f;
            tex_coords[currentIndex * 2 + 1] = 0f;
            ...
            tex_coords[currentIndex * 2] = 0.5f;
            tex_coords[currentIndex * 2 + 1] = 1f;
        }
        currentIndex = 0;
